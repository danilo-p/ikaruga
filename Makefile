...
ikaruga: copy ikaruga.o
	gcc -Wall -o $(BIN_DIR)ikaruga $(HEADER_DIR)config.c $(HEADER_DIR)common.c $(HEADER_DIR)display.c $(HEADER_DIR)menu.c $(HEADER_DIR)element.c $(HEADER_DIR)ship.c $(HEADER_DIR)bullet.c $(HEADER_DIR)game.c $(OBJ_DIR)ikaruga.o $(LIB_ALLEGRO) $(LIB_PRIMITIVES) $(LIB_IMAGE) $(LIB_TTF) $(LIB_MATH)
